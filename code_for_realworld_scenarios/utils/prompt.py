...
Dataset2Prompt = {
    ...
    'concept_400_task1': 'qa',
    'concept_400_task10': 'qa',
...
Dataset2PromptTuningInitText = {
    ...
    'concept_400_task1': 'Answer the question below:',
    'concept_400_task10': 'Answer the question below:',
...
def get_prompt(text, label, prompt_type, eos_token='', dataset='clinc150_task15'):
    ...
    if prompt_type=='auto':
        if dataset not in Dataset2Prompt.keys():
            logger.warning(f'Dataset {dataset} is not pre-defined in Dataset2Prompt, set prompt type to none by default!')
            Dataset2Prompt[dataset] = 'none'
            prompt_type = 'none'
        else:
