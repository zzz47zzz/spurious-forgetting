...
def get_ICL_params(parser):
    ...
    '''
    parser.add_argument("--ICL_same_instance", default=False, type=STR2BOOL, help="if using same instance pair for demonstration")
    parser.add_argument("--ICL_same_concept", default=False, type=STR2BOOL, help="if using same concept for demonstration")
