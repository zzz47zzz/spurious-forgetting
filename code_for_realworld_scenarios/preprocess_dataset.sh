...
python utils/dataformat_preprocess.py --dataset TRACE --seed 1
python utils/dataformat_preprocess.py --dataset zsre --seed 1
python utils/dataformat_preprocess.py --dataset concept_1k --seed 1
python utils/dataformat_preprocess.py --dataset safety_alignment --seed 1
